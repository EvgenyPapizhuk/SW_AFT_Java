 ...
 * 2021-06-12T19:45:19.575+03:00
 * Generated source version: 3.4.4
 *
 */
@WebServiceClient(name = "GeoIPService",
                  wsdlLocation = "C:/SWprojects/SW_AFT_Java/soap-sample/src/main/resources/ipservice2.wsdl",
...
public class GeoIPService extends Service {
    ...
    static {
        URL url = GeoIPService.class.getResource("C:/SWprojects/SW_AFT_Java/soap-sample/src/main/resources/ipservice2.wsdl");
        if (url == null) {
            url = GeoIPService.class.getClassLoader().getResource("C:/SWprojects/SW_AFT_Java/soap-sample/src/main/resources/ipservice2.wsdl");
        }
        if (url == null) {
            java.util.logging.Logger.getLogger(GeoIPService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "C:/SWprojects/SW_AFT_Java/soap-sample/src/main/resources/ipservice2.wsdl");
        }
        WSDL_LOCATION = url;
    }
    ...
    public com.lavasoft.GeoIPServiceHttpGet getGeoIPServiceHttpGet() {
